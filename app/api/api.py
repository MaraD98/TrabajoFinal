...
if __name__ == "__main__":
    event_created = register_event()
    
    if event_created:
        print("\n--- DETALLE DEL EVENTO CREADO (HU 1.2) ---")
        for key, value in event_created.items():
            print(f"{key.capitalize()}: {value}")
    else:
        print("\nProceso de registro cancelado debido a errores o falta de autenticación.")